...
public class PaymentRefundResponse  extends com.turkcelltech.cpgw.ws.ResponseType  implements java.io.Serializable {
    ...
    /**
     * Gets the paymentRefund value for this PaymentRefundResponse.
     * 
    ...
    /**
     * Sets the paymentRefund value for this PaymentRefundResponse.
     * 
     * @param paymentRefund
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof PaymentRefundResponse)) return false;
        PaymentRefundResponse other = (PaymentRefundResponse) obj;
        ...
        _equals = super.equals(obj) && 
            ((this.paymentRefund==null && other.getPaymentRefund()==null) || 
             (this.paymentRefund!=null &&
              this.paymentRefund.equals(other.getPaymentRefund())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getPaymentRefund() != null) {
            _hashCode += getPaymentRefund().hashCode();
        }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(PaymentRefundResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ws.cpgw.turkcelltech.com/", "paymentRefundResponse"));
